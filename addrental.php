    ...
    <div class="card p-5">
      ...
      <form action="addorderental.php" method="post" name="form1">
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              <label label label>Customer Name</label>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="date" name="receivedate" class="form-control" placeholder="Receive Date">
            </div>
            <div class="form-group col-md-4">
       	  ...
       	  <div class="row">
		      	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		      		<table class="table table-bordered table-hover" id="invoiceItem">	
							...
							<tr>
								...
								<td><input type="number"  name="quantity" class="form-control quantity px-1" autocomplete="off"></td>
								...
								<td>
								  <button class="btn btn-danger delete"  type="button" id="hide">Delete</button>
								  <button class="btn btn-success" id="show" type="button">Add</button>
								</td>						
							</tr>
							<tr id="p"  style="display:none;">
								...
								<td><input type="number"  name="quantity2" class="form-control quantity px-1" autocomplete="off"></td>
								...
								<td>
									<button class="btn btn-danger delete"  type="button" id="hide1">Delete</button>
									<button class="btn btn-success" id="show1" type="button">Add</button>
								</td>
							</tr>	
							...
							<tr id="p2"  style="display:none;">
								...
								<td><input type="number"  name="quantity3" class="form-control quantity px-1" autocomplete="off"></td>
								...
								<td>
								  <button class="btn btn-danger delete"  type="button" id="hide2">Delete</button>
								  <button class="btn btn-success" id="show2" type="button">Add</button>
								</td>
							</tr>	
							...
							<tr id="p3"  style="display:none;" >
								...
								<td><input type="number"  name="quantity4" class="form-control quantity px-1" autocomplete="off"></td>
	              ...
	              <td>
	                <button class="btn btn-danger delete"  type="button" id="hide3">Delete</button>
	                <button class="btn btn-success" id="show3" type="button">Add</button>
	              </td>
							</tr>
								...
								<td><input type="number"  name="quantity5" class="form-control quantity px-1" autocomplete="off"></td>
                ...
                <td>
                  <button class="btn btn-danger delete"  type="button" id="hide4">Delete</button>
                  <button class="btn btn-success" id="show4" type="button">Add</button>
                </td>
							...
							<tr id="p5"  style="display:none;">
								...
								<td><input type="number"  name="quantity6" class="form-control quantity px-1" autocomplete="off"></td>
                ...
                <td>
                  <button class="btn btn-danger delete"  type="button" id="hide5">Delete</button>
                  <button class="btn btn-success" id="show5" type="button">Add</button>
                </td>
							</tr>
							...
							<tr id="p6"  style="display:none;">
								...
								<td><input type="number"  name="quantity7" class="form-control quantity px-1" autocomplete="off"></td>
                ...
                <td>
                  <button class="btn btn-danger delete"  type="button" id="hide6">Delete</button>
                  <button class="btn btn-success" id="show6" type="button">Add</button>
                </td>
							</tr>
							...
							<tr id="p7"  style="display:none;">
								...
								<td><input type="number"  name="quantity8" class="form-control quantity px-1" autocomplete="off"></td>
								...
								<td>
									<button class="btn btn-danger delete"  type="button" id="hide7">Delete</button>
									<button class="btn btn-success" id="show7" type="button">Add</button>
								</td>
							</tr>
							...
							<tr id="p8"  style="display:none;">
								...
								<td><input type="number"  name="quantity9" class="form-control quantity px-1" autocomplete="off"></td>
								...
								<td>
								 <button class="btn btn-danger delete"  type="button" id="hide8">Delete</button>
								 <button class="btn btn-success" id="show8" type="button">Add</button>
								</td>
							</tr>	
						  </table>
		        </div>
